...
<nav x-data="{ isOpenMobileMenu: false }" class="absolute z-50 inset-x-0 top-0 w-full bg-black/50 backdrop-blur-md  mm">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <div x-data="{ isOpen: false }"
                            ...
                            <div class="relative ml-3" @mouseenter="isOpen = true" @mouseleave="isOpen = false">
                                <div>
                                    <button type="button"
                                        class="relative flex items-center text-md font-bold gap-1 hover:text-white hover:bg-gray-700 rounded-md px-3 py-2"
                        ...
                        <a href="/esemenynaptar"
                            class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-md font-bold">Eseménynaptár</a>
                        ...
                        <div x-data="{ isOpen: false }"
                            ...
                            <div class="relative ml-3" @mouseenter="isOpen = true" @mouseleave="isOpen = false">
                                <div>
                                    <button type="button"
                                        class="relative flex text-md font-bold gap-1 hover:text-white hover:bg-gray-700 rounded-md px-3 py-2"
                                        aria-expanded="false" aria-haspopup="true">
                                        <p class="text-gray-300">
    ...
    <div x-show="isOpenMobileMenu" class="lg:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2 text-gray-300">
            <a href="#" class="bg-gray-900 text-white rounded-md px-3 py-2 text-md font-bold"
                aria-current="page">Kezdőlap</a>
            ...
            <div x-data="{ isOpen: false }" class="flex items-center text-white">
                <div class="flex flex-col" @click="isOpen = !isOpen">
                    <div>
                        <button type="button"
                            class="flex text-md font-bold gap-1 hover:text-white hover:bg-gray-700 rounded-md px-3 py-2"
                            aria-expanded="false" aria-haspopup="true">
                            <p class=">
                                Rólunk</p>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    ...
                    <div x-show="isOpen" @click.away="isOpen = false"
                        ...
                        role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button"
                        tabindex="-1">
                        <a href="#" class="block px-4 py-2 text-md font-bold" role="menuitem" tabindex="-1"
            ...
            <a href="#" class="text-white rounded-md px-3 py-2 text-md font-bold"
